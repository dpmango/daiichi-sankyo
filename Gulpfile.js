...
gulp.task('list-pages', function() {
	delete require.cache[require.resolve('./app/index/pages-list.yaml')]
  var pages = require('./app/index/pages-list.yaml');
  return gulp
...
gulp.task('watch', function(){
    ...
    watch('./app/index/pages-list.yaml', function(event, cb) {
